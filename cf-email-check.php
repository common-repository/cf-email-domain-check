...
function EDCCF_email_domain_processor($processors){
	$processors['email_check_cf_validator'] = array(
		...
		'description' => __('Check if the eMail domain has an MX or A or AAAA record', 'cf-email-domain-check' ),
...
function EDCCF_email_domain_validator( array $config, array $form ){
	...
	if ( $has_no_mx ){
		...
		return array(
			...
			'note' => sprintf(__( 'Please correct the %s field', 'cf-email-domain-check' ), $label ),
